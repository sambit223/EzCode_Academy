...
const FeedbackCard = ({ text = "Feedback", name , className, handleMouseEnter }) => {
  return (
    <div onMouseOut={handleMouseEnter} className={`feedback-card flex relative flex-col justify-center p-4 gap-2 items-center m-4 border border-white shadow-md shadow-black h-[15rem] w-[15rem] ${className}`}>
